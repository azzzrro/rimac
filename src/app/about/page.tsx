        ...
        <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 h-full">
          <div className="flex-1 z-10">
            ...
            <p className="text-sm mb-6">
              ...
              building materials in Saudi Arabia. With a strong commitment to
              innovation, quality, and customer satisfaction, RIMAC has
              established itself as a trusted partner for construction projects
              across the region.
            </p>
